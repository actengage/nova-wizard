...
Nova.booting(function (Vue, router, store) {
    var isWizardInstance = false;

    // Add a request interceptor to append to current step to the request
    Nova.request().interceptors.request.use(function (config) {
        var step = parseInt(router.currentRoute.query.step || 1);

        config.step = step;

        if (config.method === 'get') {
            config.params = Object.assign(config.params || {}, { step: step });
        } else if (config.data) {
    ...
    router.beforeEach(function (to, from, next) {
        ...
        if (resourceName && (name === 'create' || name === 'edit') && matched.components.default.mixins.indexOf(__WEBPACK_IMPORTED_MODULE_0__mixin__["a" /* default */]) === -1) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_deep_diff__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_deep_diff___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_deep_diff__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_FillFormFields__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_FillFormFields___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_FillFormFields__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_ProgressBar__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_ProgressBar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_ProgressBar__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_SubmitButton__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_SubmitButton___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__components_SubmitButton__);
...
/* harmony default export */ __webpack_exports__["a"] = (function (Nova, Vue) {
    var _watch;

    return {
        components: {
            SubmitButton: __WEBPACK_IMPORTED_MODULE_5__components_SubmitButton___default.a
        },
        ...
        watch: (_watch = {
            ...
            _.each(fields, function (field, i) {
                if (_this.fieldData[field.attribute]) {
                    Object.assign(field, _this.fieldData[field.attribute], {
                        panel: field.panel
                    });
                }
            });
        ...
        beforeRouteUpdate: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(_ref, from, next) {
                var step = _ref.query.step;
        ...
        methods: {
            getFormData: function getFormData() {
                ...
                return Object.entries(this.formData).reduce(function (formData, _ref3) {
                    var _ref4 = _slicedToArray(_ref3, 2),
                        step = _ref4[0],
                        stepFormData = _ref4[1];

                    Array.from(stepFormData).forEach(function (_ref5) {
            ...
            createFillComponent: function createFillComponent(steps) {
                this.fillComponent = new (Vue.extend(__WEBPACK_IMPORTED_MODULE_3__components_FillFormFields___default.a))({
                    parent: this,
                    propsData: {
                        steps: steps,
            ...
            createNextButton: function createNextButton() {
                ...
                this.nextButton = new (Vue.extend(__WEBPACK_IMPORTED_MODULE_5__components_SubmitButton___default.a))({
                    el: el,
                    parent: this,
                    propsData: {
                        classes: 'ml-3',
                ...
                this.$el.querySelector('form').addEventListener('submit', function (e) {
                    _this2.nextButton.disabled = true;
                    _this2.nextButton.processing = true;
                });
            ...
            createProgressBar: function createProgressBar() {
                ...
                this.progressBar = new (Vue.extend(__WEBPACK_IMPORTED_MODULE_4__components_ProgressBar___default.a))({
                    el: el,
                    parent: this,
                    propsData: {
                ...
                this.progressBar.$on('click', function () {
                    var _ref7 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(step) {
                        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                            while (1) {
                                switch (_context2.prev = _context2.next) {
                                    case 0:
                                        _this3.$root.$refs.loading.start();

                                        _context2.prev = 1;
                                        _context2.next = 4;
                                        return _this3.validateStep();
                                    ...
                                    case 7:
                                        ...
                                        _this3.validateRequestFailed(_context2.t0);
                                        _this3.focusOnFirstError(_context2.t0);

                                    case 11:

                                        _this3.$root.$refs.loading.finish();
                ...
                this.progressBar.$on('finish', _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3() {
                    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
                        while (1) {
                            switch (_context3.prev = _context3.next) {
                                case 0:
                                    _this3.$root.$refs.loading.start();
                                    _this3.progressBar.processing = true;
                                ...
                                case 5:
                                    _context3.next = 7;
                                    return _this3.submitMultiStepForm();
                                ...
                                case 9:
                                    ...
                                    _this3.validateRequestFailed(_context3.t0);
                                    _this3.focusOnFirstError(_context3.t0);

                                case 13:

                                    _this3.progressBar.processing = false;
                                    _this3.$root.$refs.loading.finish();
            ...
            createSaveChangesButton: function createSaveChangesButton() {
                ...
                this.saveChangesButton = new (Vue.extend(__WEBPACK_IMPORTED_MODULE_5__components_SubmitButton___default.a))({
                    el: el,
                    parent: this,
                    propsData: {
                        label: 'Save & Continue',
                ...
                this.saveChangesButton.$on('click', function () {
                    var _ref9 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee4(e) {
                        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee4$(_context4) {
                            while (1) {
                                switch (_context4.prev = _context4.next) {
                                    case 0:
                                        _this4.$root.$refs.loading.start();
                                        _this4.saveChangesButton.processing = true;

                                        _context4.prev = 2;
                                        _context4.next = 5;
                                        return _this4.validateStep();

                                    case 5:
                                        _context4.next = 7;
                                        return _this4.submitMultiStepForm(false);
                                    ...
                                    case 9:
                                        ...
                                        _this4.validateRequestFailed(_context4.t0);
                                        _this4.focusOnFirstError(_context4.t0);

                                    case 13:

                                        _this4.saveChangesButton.processing = false;
                                        _this4.$root.$refs.loading.finish();
            ...
            createPrevButton: function createPrevButton() {
                ...
                this.prevButton = new (Vue.extend(__WEBPACK_IMPORTED_MODULE_5__components_SubmitButton___default.a))({
                    el: el,
                    parent: this,
                    propsData: {
                        classes: 'ml-3',
                ...
                this.prevButton.$on('click', _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee5() {
                    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee5$(_context5) {
                        while (1) {
                            switch (_context5.prev = _context5.next) {
                                case 0:
                                    _this5.$root.$refs.loading.start();
                                    _this5.prevButton.processing = true;
                                ...
                                case 8:
                                    ...
                                    _this5.validateRequestFailed(_context5.t0);
                                    _this5.focusOnFirstError(_context5.t0);

                                case 12:

                                    _this5.prevButton.processing = false;
            ...
            focusOnFirstError: function focusOnFirstError(e) {
                if (e.response && e.response.data) {
                    ...
                    if (entries.length) {
                        ...
                        var _step = this.steps.indexOf(_.find(this.steps, function (step) {
                            return !!_.find(step.fields, function (_ref11) {
                                var attribute = _ref11.attribute;
                                return key === attribute;
                            });
                        })) + 1;

                        if (_step && this.currentStep !== _step) {
                            this.$router.push({
                                query: { step: _step }
                            });
                        }
            ...
            hideDefaultSubmitButtons: function hideDefaultSubmitButtons() {
                var _this6 = this;

                Array.from(this.$parent.$el.querySelectorAll('button')).filter(function (child) {
                    return child !== _this6.$el;
                }).forEach(function (el) {
            ...
            submitViaNextButton: function () {
                var _ref12 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee6(e) {
                ...
                function submitViaNextButton(_x6) {
                    return _ref12.apply(this, arguments);
                }

                return submitViaNextButton;
            }(),
            ...
            validateStep: function () {
                var _ref13 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee7() {
                    ...
                    var formData, uri, _ref14, fields;
                        ...
                        while (1) {
                            switch (_context7.prev = _context7.next) {
                                case 0:
                                    ...
                                    uri = '/nova-vendor/wizard/validate/' + this.resourceName + (this.resourceId ? '/' + this.resourceId : '');
                                    _context7.next = 4;
                                    return Nova.request().post(uri, formData);

                                case 4:
                                    _ref14 = _context7.sent;
                                    fields = _ref14.data.fields;


                                    fields.forEach(function (field) {
                                        _this8.fieldData[field.attribute] = field;
                                    });

                                    this.subject.validationErrors = new __WEBPACK_IMPORTED_MODULE_2_laravel_nova__["Errors"]();
            ...
            submitMultiStepForm: function () {
                var _ref15 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee8() {
                    var shouldRedirect = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
                    ...
                    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee8$(_context8) {
                        while (1) {
                            switch (_context8.prev = _context8.next) {
                                case 0:
                                    _context8.next = 2;
                                    return (this.subject.createRequest || this.subject.updateRequest)();

                                case 2:
                                    _ref16 = _context8.sent;
                                    redirect = _ref16.data.redirect;


                                    Nova.success(this.__('The :resource was saved!', {
                                        resource: this.resourceInformation.singularLabel.toLowerCase()
                                    }));

                                    shouldRedirect && this.$router.push({ path: redirect }, function () {
                                        window.scrollTo(0, 0);
                                    });
            ...
            validateRequestFailed: function validateRequestFailed(error) {
                ...
                if (error.response.status == 422) {
                    this.subject.validationErrors = new __WEBPACK_IMPORTED_MODULE_2_laravel_nova__["Errors"](error.response.data.errors);
        ...
        destroyed: function destroyed() {
            this.events.forEach(function (_ref17) {
                var key = _ref17.key,
        ...
        created: function created() {
            ...
            this.on('nova.wizard.request', function (config) {
                if (_this9.sessionId) {
                    config.headers['wizard-session-id'] = _this9.sessionId;
                }
            });

            // These events are broken apart to be executed in specific orders.
            this.once('nova.wizard.response', function () {
                _this9.subject = _this9.$children[0] && _this9.$children[0].submitViaCreateResource ? _this9.$children[0] : _this9;

                _this9.subject.createResourceFormData = function () {
                    return _this9.getFormData();
                };
                _this9.subject.submitViaCreateResource = function () {
                    var _ref18 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee9(e) {
                        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee9$(_context9) {
                            while (1) {
                                switch (_context9.prev = _context9.next) {
                                    case 0:
                                        return _context9.abrupt('return', _this9.submitViaNextButton(e));
                ...
                _this9.subject.submitViaUpdateResource = function () {
                    var _ref19 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee10(e) {
                        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee10$(_context10) {
                            while (1) {
                                switch (_context10.prev = _context10.next) {
                                    case 0:
                                        return _context10.abrupt('return', _this9.submitViaNextButton(e));
                ...
                _this9.resourceInformation = _this9.subject.resourceInformation;

                _this9.$watch(function () {
                    return _this9.subject.loading;
                }, function () {
                    _this9.initialize();
                });
            });

            this.on('nova.wizard.response', function (_ref20) {
                var steps = _ref20.data.steps,
                    headers = _ref20.headers;

                if (headers['wizard-session-id']) {
                    _this9.sessionId = headers['wizard-session-id'];
                    _this9.currentStep = Number(headers['wizard-current-step']);
                    _this9.totalSteps = Number(headers['wizard-total-steps']);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3ab709ab", Component.options)
  } else {
    hotAPI.reload("data-v-3ab709ab", Component.options)
  }
    ...
    methods: {
        ...
        */
        fill: function fill(formData) {
            ...
            this.$refs.steps.forEach(function (step) {
                var index = Number(step.getAttribute('data-step'));

                formData[index] = new FormData();

                if (_this.$refs['fields[' + index + ']']) {
                    _this.$refs['fields[' + index + ']'].forEach(function (field) {
...
var render = function() {
  ...
  return _c(
    "div",
    _vm._l(_vm.steps, function(ref, i) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3ab709ab", module.exports)
  }
}
...
var update = __webpack_require__(16)("ceb894f2", content, false, {});
